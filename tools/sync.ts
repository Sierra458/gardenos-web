...
const ALLOWED_TOP = ["Architecture", "Hardware", "Software", "Daily Log", "Photos", "Plant Logs", "Research"];
...
const MANAGED_PATHS = ["index.md", "architecture/", "hardware/", "software/", "log/", "photos/", "plant-logs/", "research/"];
